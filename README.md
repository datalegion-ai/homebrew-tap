...
```bash
brew upgrade datalegion-ai/tap/datalegion-cli
```

## Uninstall

```bash
brew uninstall datalegion-ai/tap/datalegion-cli
```
...
| Formula | Description |
|---------|-------------|
| `datalegion-cli` | CLI for the Data Legion API — agent-friendly, fully async |
